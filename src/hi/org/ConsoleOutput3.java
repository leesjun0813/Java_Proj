...
public class ConsoleOutput3 {
	public static void main(String[] args) {
		...
		System.out.println("우리 아버님 이름은 " + fatherName +"이고, 우리 어머님 이름은 " + motherName
				+" 입니다. \n나의 이름은 " + myName + " 이고, 나이는 " + age + "살이고, 몸무게는 "
						+ weith + "입니다." );
		
		// 2. print();
		System.out.println("======print() 으로 출력========");
		System.out.print("우리 아버님 이름은 " + fatherName +"이고, 우리 어머님 이름은 " + motherName
				+" 입니다. \n나의 이름은 " + myName + " 이고, 나이는 " + age + "살이고, 몸무게는 "
						+ weith + "입니다.\n" );
		...
		System.out.printf("우리 아버님 이름은 %s 이고, 우리 어머님 이름은 %s 입니다. \n나의 이름은 %s 이고, "
				+ "나이는 %d 살이고, 몸무게는 %2.1f 입니다." , fatherName, motherName, myName, age ,weith );
